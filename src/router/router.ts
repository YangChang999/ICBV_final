...
const demoRoutes = [
  ...
  },
  {
    ...
    name: 'wildcard-debug',
    beforeEnter: (to: { path: any; }, from: any, next: () => void) => {
      console.log('Intercepted by Vue Router:', to.path);
      next();
    },
    component: () => import('@/views/pages/speciality/Error404/index.vue'), // Optional
  },
  {
    path: '/demos/classic',
    name: 'demos.classic',
