  ...
  <b-card no-body class="border bg-transparent overflow-hidden p-0 h-100">
    ...
    >
      <span class="badge text-bg-danger"
        >{{ product.sale.discount }}<span v-if="product.sale.type == 'percent'">%</span> off
      </span>
    </div>
    ...
    <b-card-header class="bg-light rounded m-2">
      <img v-for="(image, idx) in product.images" :src="`/src/assets/images/shop/${image}.png`"  alt="" :key="idx" />
    </b-card-header>
